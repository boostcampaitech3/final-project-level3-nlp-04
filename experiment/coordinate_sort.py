...
def coordinate_sort_with_sector(api_output):
    ...
    # ret.keys() 는 defaultdict 형태안에 list 형태라 
    # list로 감싸줘야합니다.
    # ret.keys()는 섹터 id 를 가지고 있습니다.
    # 실험용으로 인덱스 하나하나 찍어보시면 됩니다. 
    for dat in ret[list(ret.keys())[5]]:
        print(dat['text'], end=" ")
        

# TEST
# You should download test image in ./data folder
file_dir = "./data/test_image/test_image_vflat/vflat_image_3.jpg"
api_output = upload_local_file(file_dir)
coordinate_sort_with_sector(api_output=api_output)
